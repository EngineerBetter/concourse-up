...
echo "DEPLOY WITH AUTOGENERATED CERT, NO DOMAIN, DEFAULT WORKERS, AND DEFAULT DATABASE SIZE"
...
echo "DEPLOY WITH AUTOGENERATED CERT, AND CUSTOM DOMAIN, 2 MEDIUM WORKERS, AND LARGE DB"
